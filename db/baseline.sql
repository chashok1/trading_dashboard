...
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'drv_quote' AND table_schema = 'public') AND
       EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'drv_quote' AND column_name = 'symbol') THEN
        UPDATE drv_quote SET tos_symbol = symbol WHERE tos_symbol IS NULL;
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'drv_ma' AND table_schema = 'public') AND
       EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'drv_ma' AND column_name = 'symbol') THEN
        UPDATE drv_ma SET tos_symbol = symbol WHERE tos_symbol IS NULL;
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'drv_dash' AND table_schema = 'public') AND
       EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'drv_dash' AND column_name = 'symbol') THEN
        UPDATE drv_dash SET tos_symbol = symbol WHERE tos_symbol IS NULL;
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'drv_stks' AND table_schema = 'public') AND
       EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'drv_stks' AND column_name = 'symbol') THEN
        UPDATE drv_stks SET tos_symbol = symbol WHERE tos_symbol IS NULL;
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'drv_trig' AND table_schema = 'public') AND
       EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'drv_trig' AND column_name = 'symbol') THEN
        UPDATE drv_trig SET tos_symbol = symbol WHERE tos_symbol IS NULL;
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'drv_cs_realized_gain' AND table_schema = 'public') AND
       EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'drv_cs_realized_gain' AND column_name = 'symbol') THEN
