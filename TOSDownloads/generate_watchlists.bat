...
REM WL*.csv/overflow.csv -> C:\Ashok\Investing\Stocks\Watchlists\TOS\Watchlists\
REM   (settings.watchlist_files_dir)
REM additions.csv/removals.csv -> C:\Ashok\Investing\Stocks\Watchlists\TOS\
REM   (settings.watchlist_lists_dir)

cd /d "C:\Ashok\Invest\Projects\trading-dashboard"

echo === Generating Tier 1 watchlist files only (WL1-13) ===
